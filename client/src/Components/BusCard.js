  ...
  const viewSeats = () => {
    ...
    const func = async () => {
      ...
      const buses = await fetch(
        `https://redbus-server.onrender.com/fetchUserDetails?BusID=${props.busid}&FromDate=${date}`
      )
    ...
    <div className="mb-4 ">
      <div className="border-2 border-gray-300 flex rounded-md ">
        <div className="basis-3/4 border-r-2 border-gray-300 text-left p-4">
          <div className="flex ">
            <div className="font-bold">
              ...
              <span className="bg-[#991b1b] rounded-md text-white p-0.5 ml-2">
        ...
        <div className="basis-1/4 p-4">
          ...
          <button
            className="bg-[#991b1b] text-white font-[Poppins] mt-3 py-2 px-8 rounded  hover:bg-indigo-400 
    duration-500"
            onClick={viewSeats}
          >
            View Seat
            ...
            <div className="basis-1/3 border-2 border-gray-300 rounded-md">
              <div className="my-2 mx-3 text-start">
                ...
                <div>
                  <button
                    onClick={handleClick}
                    className="bg-[#991b1b] text-white font-[Poppins] mt-6 py-2 px-8 w-full rounded  hover:bg-indigo-400 
    duration-500"
                  >
